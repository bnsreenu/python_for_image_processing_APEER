...
This example uses the built-in IoU from Keras
from keras.metrics import MeanIoU

please 'pip install keras' to use this module. 
"""
...
jaccard_score = metrics.jaccard_score(y_test, prediction_RF, average='macro')
print("Jaccard score is :", jaccard_score)  

#Using IoU from Keras
#Using built in keras function
from keras.metrics import MeanIoU
num_classes = 4
IOU_RF = MeanIoU(num_classes=num_classes)  
IOU_RF.update_state(y_test, prediction_RF)
print("Mean IoU for Random Forest = ", IOU_RF.result().numpy())  #Should be same as the one from sklearn with average='macro'
